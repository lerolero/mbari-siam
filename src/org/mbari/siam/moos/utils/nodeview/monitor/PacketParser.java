...
public class PacketParser implements Parser {
	...
	System.out.println("PacketParser get("+field+")");
	if( field < DEVICE_PACKET_FIELDS){
	    System.out.println("PacketParser: field["+field+"]="+_fields.elementAt(field));
	    return _fields.elementAt(field);
	}else{
	    System.out.println("PacketParser: field out of range "+field);
	    return null;
	}
    }
