...
public class NAL9601MessagingService 
    ...
    protected static final int MAX_DOWNLINK_MSG_BYTES = 340;
    protected static final int MAX_UPLINK_MSG_BYTES = 270;

    public NAL9601MessagingService(String serialPortName) 
	throws Exception {
	...
	NAL9601MessagingService service = null;

	try {
	    service = new NAL9601MessagingService(serialPortName);
	}
	catch (Exception e) {
	...
	try {
	    ...
	    _log4j.error("Error while binding service: ", e);
	}
