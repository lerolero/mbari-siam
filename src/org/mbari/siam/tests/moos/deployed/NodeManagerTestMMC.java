...
public class NodeManagerTestMMC extends TestCase
{
    static private Logger _logger=Logger.getLogger(NodeManagerTest.class);


    public NodeManagerTestMMC(String methodName) {
	super(methodName);
...
// End of SampleInstrument dump
	...
	suite.addTest(new NodeManagerTestMMC("testEmptyCollection"));

	_logger.debug("Test.suite() adding getParent...()");	
	suite.addTest(new NodeManagerTestMMC("getParentId"));

	_logger.debug("Test.suite() adding testNodeManager...()");	
	suite.addTest(new NodeManagerTestMMC("testNodeManagerConstructor"));
