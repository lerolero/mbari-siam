...
public abstract class Seabird
    ...
    //    protected byte[] _getCalInfo = "DC\r".getBytes();

    //    protected byte[] _getCalEcho = "DC\r\n".getBytes();
    ...
    static final long DEFAULT_SAMPLE_TIMEOUT = 15000;
    ...
    public Seabird() throws RemoteException {
        ...
        try {
            setSampleTimeout(DEFAULT_SAMPLE_TIMEOUT);// timeout for getting one
            // fix
            setMaxSampleTries(3);
        }
    ...
    */
    ...
    public org.mbari.isi.interfaces.DevicePacketParser getDevicePacketParser() throws NotSupportedException {
    ...
    protected class Attributes extends InstrumentServiceAttributes {
        ...
        /**
         * Flag indicates if data is logged internally (but still polled; use TSS if true, TS if false)
         */
        boolean log = true;

	/** Operate in autonomous sampling mode if true (log data even if not polled; use SL) */
    ...
    public class DevicePacketParser extends org.mbari.isi.interfaces.DevicePacketParser {
