...
public class Aquadopp extends StreamingInstrumentService
    ...
    protected int initMaxSampleBytes() {
		...
		// !May need to be decreased to 512!
		// 11/17/09 klh: not sure why this limit exists; increasing this
		// from 1024 to 2048 work with high-res aquadopp firmware
        return 2048;  
    }
    ...
    public DevicePacketParser getDevicePacketParser() throws NotSupportedException {
        ...
        if (devicePacketParser == null) {
            ...
            devicePacketParser = new org.mbari.siam.devices.nortek.DevicePacketParser(_instrumentConfig);
        }
	...
	int nBytes =
	    DataStructure.read(_fromDevice, sample,
			       (_attributes.measurementIntervalSec+2)*1000);
