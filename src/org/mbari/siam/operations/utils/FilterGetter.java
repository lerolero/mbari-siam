...
/**
   FilterGetter gets and displays default telemetry filtering for 
   specified device ID
 */
public class FilterGetter extends NodeUtility {

    static private Logger _log4j = Logger.getLogger(FilterGetter.class);
	...
	BasicConfigurator.configure();
        ...
        FilterGetter app = new FilterGetter();
	...
	try {
	    ...
	    filters = instrument.getDefaultPacketFilters();
	}
	...
	for (int i = 0; i < filters.length; i++) {
	    System.out.println("filter " + i + ": " + filters[i]);
	}
    }
