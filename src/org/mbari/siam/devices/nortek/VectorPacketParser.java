 ...
 */
/*
  $Id: VectorPacketParser.java,v 1.10 2012/12/17 21:34:13 oreilly Exp $
  $Name: HEAD $
  $Revision: 1.10 $
*/
...
public class VectorPacketParser extends PacketParser {
	...
	if (packet.getRecordType() == org.mbari.siam.devices.nortek.Vector.RECORDTYPE_AVG_VEL) {
	...
	else if(DataStructure.id(dataBytes)==DataStructure.ID_VECTOR_SYSTEM_DATA){
