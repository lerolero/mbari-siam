...
public class SimulatedVector extends org.mbari.siam.devices.nortek.Vector
    implements AquadoppIF, Safeable
{
    /** log4j Logger */
    static private Logger _log4j2 = Logger.getLogger(SimulatedVector.class);
    ...
    {
	_log4j2.debug("Allocating new _avgDataPkt, ID = " + getId());
    ...
    /** Service attributes. */
    public class SimulatedVectorAttributes extends org.mbari.siam.devices.nortek.Vector.VectorAttributes
    {
	    ...
	    throws InvalidPropertyException
	{
		...
		try {
		    ...
		    _curKey = newKey;
		    _log4j2.info("New keyTime: " + keyTime);
		} catch (ParseException e) {
		    _log4j2.warn("Non-parseable keyTime found: " + keyTime);
		}
            }
        }
    }
