 ...
 * @version $Id: NumberUtil.java,v 1.1 2008/11/04 22:17:57 bobh Exp $
 */
public class NumberUtil {
     ...
     *
     * @param  si  the input array
     * @return     The signed short value coresponding to the byte array
     */
     ...
     * @return An unsigned 'short'. In order to get the full range of an unsigned short a Java int is returned.
     */
    public static int toUnsignedInt(byte lsb, byte msb) {
